...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const eduflowFeatureTextsRaw = t("projects.eduflow.features");
  const eduflowFeatureTexts = Array.isArray(eduflowFeatureTextsRaw)
    ? eduflowFeatureTextsRaw
    : [];
  const eduflowFeatureEntries = [
    { icon: GripHorizontal, text: eduflowFeatureTexts[0] },
    { icon: FileText, text: eduflowFeatureTexts[1] },
    { icon: Smartphone, text: eduflowFeatureTexts[2] },
    { icon: Link2, text: eduflowFeatureTexts[3] },
    { icon: Paintbrush, text: eduflowFeatureTexts[4] },
    { icon: Lock, text: eduflowFeatureTexts[5] },
    { icon: Database, text: eduflowFeatureTexts[6] },
                ...
                <div className="p-6 flex flex-col justify-center">
                  <CardHeader className="p-0 mb-4">
                    ...
                    <CardDescription className="text-muted-foreground">
                      {t("projects.eduflow.category")}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-0 space-y-6">
                    <p className="text-muted-foreground">
                      {t("projects.eduflow.description")}
                    </p>
                    <p className="text-muted-foreground">
                      {t("projects.eduflow.longDescription")}
                    </p>
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {eduflowTechnologies.map((tech) => (
                          <Badge
                            key={`eduflow-tech-${tech}`}
                            variant="outline"
                    ...
                    {eduflowFeatureEntries.length > 0 && (
                      <div>
                        <h4 className="text-foreground mb-2">
                          {t("projects.keyFeatures")}
                        </h4>
                        <ul className="grid gap-2 sm:grid-cols-2">
                          {eduflowFeatureEntries.map(({ icon: Icon, text }, index) => (
                            <li
                              key={`eduflow-feature-${index}`}
                    ...
                    <Button
                      onClick={() => onNavigate("projects")}
                      className="bg-primary hover:bg-primary/90 mt-2 group"
                    >
